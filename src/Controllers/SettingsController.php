...
namespace SaltEmployeeTimesheet\Controllers;
...
use SaltEmployeeTimesheet\Models\Settings;
...
{
    protected $modelNamespace = 'SaltEmployeeTimesheet';
    ...
    public function index(Request $request) {
        ...
        try {
            ...
            $count = $this->model->where('group', 'timesheet_settings')->count();
            $model = $this->model->where('group', 'timesheet_settings')->filter();
